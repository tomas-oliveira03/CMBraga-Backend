...
(function (CronExpression) {
    ...
    CronExpression["EVERY_2_MINUTES"] = "*/2 * * * *";
    CronExpression["EVERY_5_MINUTES"] = "*/5 * * * *";
    CronExpression["EVERY_10_MINUTES"] = "*/10 * * * *";
    CronExpression["EVERY_15_MINUTES"] = "*/15 * * * *";
    CronExpression["EVERY_30_MINUTES"] = "*/30 * * * *";
    CronExpression["EVERY_HOUR"] = "0 * * * *";
    CronExpression["EVERY_HOUR_AND_55_MINUTES"] = "55 * * * *";
    CronExpression["EVERY_2_HOURS"] = "0 */2 * * *";
    CronExpression["EVERY_3_HOURS"] = "0 */3 * * *";
    CronExpression["EVERY_4_HOURS"] = "0 */4 * * *";
    CronExpression["EVERY_5_HOURS"] = "0 */5 * * *";
    CronExpression["EVERY_6_HOURS"] = "0 */6 * * *";
    CronExpression["EVERY_7_HOURS"] = "0 */7 * * *";
    CronExpression["EVERY_8_HOURS"] = "0 */8 * * *";
    CronExpression["EVERY_9_HOURS"] = "0 */9 * * *";
    CronExpression["EVERY_10_HOURS"] = "0 */10 * * *";
    CronExpression["EVERY_11_HOURS"] = "0 */11 * * *";
    CronExpression["EVERY_12_HOURS"] = "0 */12 * * *";
    ...
    CronExpression["MONDAY_AT_9AM"] = "0 9 * * 1";
