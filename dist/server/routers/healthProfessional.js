...
router.get('/', async (req, res) => {
    const allHealthProfessionals = await db_1.AppDataSource.getRepository(HealthProfessional_1.HealthProfessional).find();
...
router.put('/:id', async (req, res) => {
    try {
        const healthProfessionalId = req.params.id;
        const validatedData = healthProfessional_1.UpdateHealthProfessionalSchema.parse(req.body);
        ...
        await db_1.AppDataSource.getRepository(HealthProfessional_1.HealthProfessional).update(healthProfessional.id, {
            ...validatedData,
            updatedAt: new Date()
        });
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        await db_1.AppDataSource.getRepository(HealthProfessional_1.HealthProfessional).delete(healthProfessional.id);
