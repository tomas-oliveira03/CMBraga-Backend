...
export class AddMigrations1762301159333 implements MigrationInterface {
    name = 'AddMigrations1762301159333'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "chat" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "chat_name" character varying, "chat_type" character varying NOT NULL, "destinataire_photo" character varying NOT NULL, CONSTRAINT "CHK_691e7c4a4cc5fbd970a164d408" CHECK ("chat_type" IN ('group_chat', 'individual_chat', 'general_chat')), CONSTRAINT "PK_9d0b2ba74336710fd31154738a5" PRIMARY KEY ("id"))`);
