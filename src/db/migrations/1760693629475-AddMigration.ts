...
export class AddMigration1760693629475 implements MigrationInterface {
    name = 'AddMigration1760693629475'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "admin" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "password" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "activated_at" TIMESTAMP WITH TIME ZONE, "updated_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_de87485f6489f5d0995f5841952" UNIQUE ("email"), CONSTRAINT "PK_e032310bcef831fb83101899b10" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "route" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "distance_meters" integer NOT NULL, "bounds_north" double precision NOT NULL, "bounds_east" double precision NOT NULL, "bounds_south" double precision NOT NULL, "bounds_west" double precision NOT NULL, "metadata" jsonb NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_cc16047ba5141ec8dec50451df8" UNIQUE ("name"), CONSTRAINT "PK_08affcd076e46415e5821acf52d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "route_station" ("route_id" uuid NOT NULL, "station_id" uuid NOT NULL, "stop_number" integer NOT NULL, "distance_from_start_meters" double precision NOT NULL, "distance_from_previous_station_meters" integer NOT NULL, CONSTRAINT "PK_e6da4af38b1a244db8453302186" PRIMARY KEY ("route_id", "station_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "client_stat" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "distance_meters" integer NOT NULL, "co2_saved" integer NOT NULL, "calories_burned" integer NOT NULL, "activity_date" TIMESTAMP WITH TIME ZONE NOT NULL, "parent_id" uuid, "child_id" uuid, "activity_session_id" uuid NOT NULL, CONSTRAINT "PK_42311d46b67da5fc71f32dc3cc3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" character varying NOT NULL, "name" character varying NOT NULL, "admin_id" uuid, "instructor_id" uuid, "parent_id" uuid, "health_professional_id" uuid, CONSTRAINT "REL_c143511e72fac735b8006051e5" UNIQUE ("admin_id"), CONSTRAINT "REL_11c03fb8b962b9a304677f462f" UNIQUE ("instructor_id"), CONSTRAINT "REL_acb096eef4d8b5acdd7acbb5c8" UNIQUE ("parent_id"), CONSTRAINT "REL_09a75d99124789b3ff569bb9b0" UNIQUE ("health_professional_id"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
