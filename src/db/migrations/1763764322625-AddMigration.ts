...
export class AddMigration1763764322625 implements MigrationInterface {
    name = 'AddMigration1763764322625'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "route_connection" ("from_route_id" uuid NOT NULL, "to_route_id" uuid NOT NULL, "station_id" uuid NOT NULL, CONSTRAINT "PK_63f9c9f6c4529826b5e0808c02d" PRIMARY KEY ("from_route_id", "to_route_id", "station_id"))`);
        await queryRunner.query(`CREATE TABLE "route" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "activity_type" character varying NOT NULL, "color" character varying NOT NULL, "distance_meters" integer NOT NULL, "bounds_north" double precision NOT NULL, "bounds_east" double precision NOT NULL, "bounds_south" double precision NOT NULL, "bounds_west" double precision NOT NULL, "metadata" jsonb NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_cc16047ba5141ec8dec50451df8" UNIQUE ("name"), CONSTRAINT "CHK_eac8cf0c45107f25fcffea8d3a" CHECK ("color" IN ('red', 'blue', 'green', 'yellow', 'orange', 'purple', 'pink', 'brown')), CONSTRAINT "CHK_0ca8d8000a3a77fc584b05edf7" CHECK ("activity_type" IN ('pedibus', 'ciclo_expresso')), CONSTRAINT "PK_08affcd076e46415e5821acf52d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "child_station" ("child_id" uuid NOT NULL, "station_id" uuid NOT NULL, "activity_session_id" uuid NOT NULL, "type" character varying NOT NULL, "instructor_id" uuid NOT NULL, "registered_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "CHK_6288dedacb93c8a5deb652e03b" CHECK ("type" IN ('in', 'out')), CONSTRAINT "PK_96de6b416b651eb34dfdf372cba" PRIMARY KEY ("child_id", "station_id", "activity_session_id", "type"))`);
        ...
        await queryRunner.query(`CREATE TABLE "parent_station" ("parent_id" uuid NOT NULL, "activity_session_id" uuid NOT NULL, "instructor_id" uuid NOT NULL, "registered_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_2787581591420692571c6738a44" PRIMARY KEY ("parent_id", "activity_session_id"))`);
        await queryRunner.query(`CREATE TABLE "child_stat" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "distance_meters" integer NOT NULL, "co2_saved" integer NOT NULL, "calories_burned" integer NOT NULL, "points_earned" integer NOT NULL, "activity_date" TIMESTAMP WITH TIME ZONE NOT NULL, "activity_session_id" uuid NOT NULL, "child_id" uuid NOT NULL, CONSTRAINT "PK_ed139ec781435fa8fc7d8e2bc5e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8c7c73f1194ffc69f9e736a911" ON "child_stat" ("child_id") `);
        await queryRunner.query(`CREATE TABLE "parent_stat" ("parent_id" uuid NOT NULL, "child_stat_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_8fd9bcd283ff77b69eb1d70d57d" PRIMARY KEY ("parent_id", "child_stat_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "route_connection" ADD CONSTRAINT "FK_4d9e9ef310278871d6dac526dd4" FOREIGN KEY ("to_route_id") REFERENCES "route"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "route_connection" ADD CONSTRAINT "FK_ff888ab665768dc24b4647264e8" FOREIGN KEY ("station_id") REFERENCES "station"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "child_stat" ADD CONSTRAINT "FK_8c7c73f1194ffc69f9e736a911a" FOREIGN KEY ("child_id") REFERENCES "child"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "child_stat" ADD CONSTRAINT "FK_3785a3cddd2795122377e2b9ecd" FOREIGN KEY ("activity_session_id") REFERENCES "activity_session"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "child_activity_session" ADD CONSTRAINT "FK_4203ae478f099dcb506f3c0a30c" FOREIGN KEY ("drop_off_station_id") REFERENCES "station"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "child_activity_session" DROP CONSTRAINT "FK_4203ae478f099dcb506f3c0a30c"`);
        ...
        await queryRunner.query(`ALTER TABLE "child_stat" DROP CONSTRAINT "FK_3785a3cddd2795122377e2b9ecd"`);
        await queryRunner.query(`ALTER TABLE "child_stat" DROP CONSTRAINT "FK_8c7c73f1194ffc69f9e736a911a"`);
        ...
        await queryRunner.query(`ALTER TABLE "route_connection" DROP CONSTRAINT "FK_ff888ab665768dc24b4647264e8"`);
        await queryRunner.query(`ALTER TABLE "route_connection" DROP CONSTRAINT "FK_4d9e9ef310278871d6dac526dd4"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_4b5d60b7c0938e0eebaabc002b"`);
        ...
        await queryRunner.query(`DROP TABLE "child_stat"`);
        ...
        await queryRunner.query(`DROP TABLE "route_connection"`);
