...
class Envs {
    ...
    public readonly DATABASE_URL: string = `postgres://${this.DB_USER}:${this.DB_PASSWORD}@${this.DB_HOST}:${this.DB_PORT}/${this.DB_NAME}`
    ...
    private readonly REDIS_PASSWORD: string = this.getString("REDIS_PASSWORD", "your_redis_password");
    
    public readonly REDIS_URL: string = `redis://:${this.REDIS_PASSWORD}@${this.REDIS_HOST}:${this.REDIS_PORT}`
